...
public class AllTheWayMinActCOPIA extends CarmaModel {
	
	public AllTheWayMinActCOPIA() {
	...
	public final CarmaProcessAutomaton.State __STATE___Agent_ACTIVEIDLE = _COMP_Agent.newState("ACTIVEIDLE");		
